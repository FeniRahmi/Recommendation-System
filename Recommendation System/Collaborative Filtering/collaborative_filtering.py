"""
Created on Wed Sep 18 16:27:19 2019
...
def user_recommendations(person):
    ...
    rankings.sort()
    rankings.reverse()
    # returns the recommended items and rangkings
    recommendataions_list = [recommend_item for score,recommend_item in rankings]
    return recommendataions_list 
    
print ("Correlation value :", person_correlation('bunga','Rima'))
print ("similarity score :", similarity_score('bunga','Rima'))
print ("movie recommendations :", user_recommendations('bunga'))
